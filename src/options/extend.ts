...
import type { CompiledConfig, Config, MutationSets } from '../spec';
...
export type ExtendedConfig = Partial<Pick<CompiledConfig, 'backupPath' | 'indent'>> & Pick<CompiledConfig, MutationSets>;
